...
for k in puppets:
	...
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=nukes/container={}">Main Page</a></p></td>""".format(canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/nation={}/page=nukes/view=nukes/container={}">Nukes</a></p></td>""".format(canonical,canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/nation={}/page=nukes/view=shield/container={}">Shield</a></p></td>""".format(canonical,canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/nation={}/page=nukes/view=production/container={}">Production</a></p></td>""".format(canonical,canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=347/container={}/consider_join_faction=347&join_faction=1">Join faction page</a></p></td>""".format(canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=347/container={}/consider_leave_faction=347&leave_faction=21">Leave faction page</a></p></td>""".format(canonical))
