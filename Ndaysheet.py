...
for k in puppets:
	...
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=49/container={}/consider_join_faction=1&join_faction=1">Join faction page</a></p></td>""".format(canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=49/container={}/consider_leave_faction=1&leave_faction=1">Leave faction page</a></p></td>""".format(canonical))
