...
for k in puppets:
	...
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=21/container={}">faction page</a></p></td>""".format(canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=nukes/view=targets/container={}">Boom Boom</a></p></td>""".format(canonical))
