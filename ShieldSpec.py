...
for k in puppets:
	...
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=21/nation={}">faction page</a></p></td>""".format(canonical))
