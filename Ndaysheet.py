...
for k in puppets:
	...
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=347/nation={}/consider_join_faction=347&join_faction=1">Join faction page</a></p></td>""".format(canonical))
	links.write("""<td><p><a target="_blank" href="https://www.nationstates.net/page=faction/fid=347/nation={}/consider_leave_faction=347&leave_faction=21">Leave faction page</a></p></td>""".format(canonical))
